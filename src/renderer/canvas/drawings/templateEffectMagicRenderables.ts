...
export function createPsychicHazeImage(): HTMLCanvasElement | null {
...
export function createArcaneGlyphImage(): HTMLCanvasElement | null {
...
export function createFireTongueImage(): HTMLCanvasElement | null {

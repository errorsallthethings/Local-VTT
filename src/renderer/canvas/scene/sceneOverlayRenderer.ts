...
} from "../drawings/drawingTransform";
import type { MapCalibrationBox } from "../map/mapCalibrationGeometry";
import { pointsToSelectionRect } from "../selection/selectionGeometry";

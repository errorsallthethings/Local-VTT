...
- Extracted tested template-effect asset/glow support helpers from the drawing renderer as the first step toward separating template rendering from base drawing rendering.

...
Container_Boundary(renderer, "src/renderer") {
  ...
  Component(canvasHooks, "Scene Canvas Hooks", "React hooks", "Pointer down/move/up, keyboard interaction, lifecycle resets, map readiness, render loop, context menus, token drops, polygon drafts.")
...
Container_Boundary(sceneCanvas, "Scene Canvas Area") {
  ...
  Component(inputHooks, "Input Hooks", "React hooks", "Pointer, mouse, keyboard, wheel, token drop, context menu, and polygon draft orchestration.")
  Component(policyHelpers, "Interaction Policies", "TypeScript", "Pointer routing, selection clearing, drag commit actions, hover updates, lifecycle reset actions, and scene item payloads.")

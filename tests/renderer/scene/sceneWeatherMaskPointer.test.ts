...
import { getWeatherMaskPointerMove, getWeatherMaskPointerMoveAction, getWeatherMaskPointerStart } from "../../../src/renderer/components/scene/input/sceneWeatherMaskPointer";

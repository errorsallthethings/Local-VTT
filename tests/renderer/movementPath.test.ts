...
import { appendWaypoint, getPathDistance, getPathMidpoint, getPointAlongPath, hasMeaningfulPath, normalizeMovementPath, removeLastWaypoint } from "../../src/renderer/canvas/tokens";
